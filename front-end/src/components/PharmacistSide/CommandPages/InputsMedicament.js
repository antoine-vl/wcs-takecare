...
class InputsMedicament extends Component {
    ...
    render() { 
        const { medicament: {name, id, comment, quantity, categorie, prescription, isEdit }, updateFormMedicament , inputSubmit, handleChangeCheckboxMed, clearMedoc } = this.props;
